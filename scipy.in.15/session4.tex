% Author: FOSSEE and Prabhu Ramachandran
...
Python}
\subtitle{Basic SciPy and IPython notebooks}

\author[Prabhu] {FOSSEE}

\institute[FOSSEE -- IITB] {Department of Aerospace Engineering\\IIT Bombay}
\date[] {SciPy India, 2015\\
December, 2015
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{small}
\begin{block}{}
The last term in the matrix is should be \alert{0}!\\
...
\item $y$ is the number of infected people
\item $\frac{dy}{dt} = ky(L-y)$ gives the spread of the disease
\item $L$ is the total population.
\item Use $L = 2.5 \times 10^5, k = 3 \times 10^{-3}, y(0) = 250$
...
\frametitle{Result}
\begin{center}
\includegraphics[height=3in, interpolate=true]{data/ode_result}
\end{center}
\end{frame}
